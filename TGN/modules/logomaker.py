...
async def lego(event):
 ...
 try:
    ...
    fname2 = "Emli.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made by @DAISHINYUUROBOT")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Report @luamicifer, {e}')
...
async def lego(event):
 ...
 try:
   ...
   await event.reply(f'Error Report @luami_cifer, {e}')
